...
# # 获取token
# def get_token():
#     client_id = 'EVt4ir5lqmAT3AziSkcho3CW'
#     client_secret = 'GuYNdDK6L8Dgbq8KTF3h9G625wXGMTpg '
...
""" 你的 APPID AK SK """
APP_ID = '14760010'
API_KEY = 'EVt4ir5lqmAT3AziSkcho3CW'
SECRET_KEY = 'GuYNdDK6L8Dgbq8KTF3h9G625wXGMTpg '
...
images = [
    get_file_content('test1.jpg'),
    get_file_content('test2.jpg'),
]
import base64
""" 调用人脸比对 """
s=b'BASE64'
...
result = client.match([
    {
        'image': base64.b64encode(open('test1.jpg', 'rb').read()),
        'image_type': a,
    },
    {
        'image': base64.b64encode(open('test2.jpg', 'rb').read()),
        'image_type': a,
    }
])
print(result)
