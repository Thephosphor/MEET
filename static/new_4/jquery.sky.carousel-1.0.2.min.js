...
a.reflectionSize,a.reflectionAlpha),this.reflection.css({"float":"left",clear:"both"}),this.element.append(this.reflection),this.update());this.loaded=!0;this.publish("load",this)},setAlpha:function(a){a!=this.alpha&&(this.alpha=a,this.update())},setX:function(a){a!=this.x&&(this.scaledX+=a-this.x,this.x=a,this.update())},setY:function(a){a!=this.y&&(this.scaledY+=a-this.y,this.y=a,this.update())},setXY:function(a,b){a!=this.x&&b!=this.y&&(this.scaledX+=a-this.x,
